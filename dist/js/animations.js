...
// tracks
var trackOptions = document.querySelectorAll("div.track-option");

for (var i = 0; i < trackOptions.length; i++) {
    trackOptions[i].addEventListener("click", (function (index) {
        ...
        var track = trackOptions[index].dataset.track;
